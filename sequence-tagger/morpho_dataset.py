...
class MorphoDataset:
    ...
    def __init__(self, filename, train=None, shuffle_batches=True, max_sentences=None, add_bow_eow=False):
        ...
        print(self._factors[0].charseqs[:5])
        print(self._factors[0].charseq_ids[:5])
        print(self._factors[1].charseqs[:5])
        print(self._factors[1].charseq_ids[:5])
        print(self._factors[2].charseqs[:5])
        print(self._factors[2].charseq_ids[:5]) 
        print('ne', self._factors[2].words)
